<#
.SYNOPSIS
  This runbook will retrieve a secret from the given key vault.
...
if ($secret -eq $null)
{
	throw "Could not retrieve secret $SecretName. Check that a secret with this name exists in this key vault."
}
